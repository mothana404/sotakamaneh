        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-20 w-full">
          ...
          >
            ...
            >
              <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full border border-white/20 ">
                ...
                <span className="text-white font-medium text-sm">
                  تجربة رقمية متقدمة للانتخابات البرلمانية في العراق
                </span>
              </div>
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 text-white"
            >
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  <div className="text-4xl md:text-5xl font-bold text-white mb-2">21M</div>
            ...
            >
              ...
              <span className="text-sm font-medium">نظام الكترروني دعائي متطور أمن ومحمي</span>
            </motion.div>
          </motion.div>
        </div>
      </div>
